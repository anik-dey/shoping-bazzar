                                            ...
                                            <li class="level1 sub-level"><a href="#;" class="site-nav">Jewellery</a>
                                                <ul class="sublinks">
                                                    ...
                                                    <li class="level2"><a href="#;"
                                                            class="site-nav">Neckalses</a></li>
                                                    <li class="level2"><a href="#;"
                                                            class="site-nav">Eaarings</a></li>
                                                    <li class="level2"><a href="#;" class="site-nav">View
                                                            All Jewellery</a></li>
                                                </ul>
                                            </li>
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <ul class="swatches">
                                                    ...
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant2.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant3.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant4.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant5.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant6.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                </ul>
                                                <!-- End Variant -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image2.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image2.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image2-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image2-1.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <ul class="swatches">
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant2-1.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant2-2.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant2-3.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant2-4.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                </ul>
                                                <!-- End Variant -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image3.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image3.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image3-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image3-1.jpg') }}"
                                                        alt="image" title="product">
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels rectangular"><span
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <ul class="swatches">
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant3-1.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant3-2.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant3-3.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant3-4.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                </ul>
                                                <!-- End Variant -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image4.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image4.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image4-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image4-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <ul class="swatches">
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant4-1.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant4-2.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant4-3.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant4-4.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                </ul>
                                                <!-- End Variant -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image5.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image5.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image5-1.jp') }}g"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image5-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels"><span class="lbl on-sale">Sale</span>
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image17.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image17.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image17-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image17-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels"><span class="lbl on-sale">Sale</span>
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image18.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image18.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image18-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image18-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-details text-center">
                                                ...
                                                <ul class="swatches">
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant5-1.jpg') }}"
                                                            alt="image" />
                                                    </li>
                                                    <li class="swatch medium rounded"><img
                                                            src="{{ asset('frontend/assets/images/product-images/variant5-1.jpg') }}"
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image19.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image19.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image19-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image19-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image20.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image20.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image20-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image20-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                    <!-- product label -->
                                                    <div class="product-labels"><span
                                                            class="lbl pr-label3">Popular</span></div>
                                                    <!-- End product label -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image21.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image21.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image21-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image21-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image22.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image22.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image22-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image22-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image23.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image23.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image23-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image23-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image24.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image24.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image24-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image24-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image25.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image25.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image25-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image25-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image26.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image26.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image26-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image26-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    ...
                                                    <img class="grid-view-item__image primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image27.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image27.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="grid-view-item__image hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image27-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image27-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image28.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image28.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image28-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image28-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image29.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image29.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image29-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image29-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image30.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image30.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image30-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image30-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <a href="#">
                                                    <!-- image -->
                                                    <img class="primary blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image31.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image31.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End image -->
                                                    <!-- Hover image -->
                                                    <img class="hover blur-up lazyload"
                                                        data-src="{{ asset('frontend/assets/images/product-images/product-image31-1.jpg') }}"
                                                        src="{{ asset('frontend/assets/images/product-images/product-image31-1.jpg') }}"
                                                        alt="image" title="product" />
                                                    <!-- End hover image -->
                                                </a>
                                                <!-- end product image -->
                                        ...
                                        <div class="product-details-img">
                                            <div class="pl-20">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                    alt="" />
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="product-form__item">
                                                        ...
                                                        <div data-value="Red"
                                                            ...
                                                            <label class="swatchLbl color medium rectangle"
                                                                for="swatch-0-red"
                                                                style="background-image:url({{ asset('frontend/assets/images/product-detail-page/variant1-1.jpg') }});"
                                                                title="Red"></label>
                                                        </div>
                                                        <div data-value="Blue"
                                                            ...
                                                            <label class="swatchLbl color medium rectangle"
                                                                for="swatch-0-blue"
                                                                style="background-image:url({{ asset('frontend/assets/images/product-detail-page/variant1-2.jpg') }});"
                                                                title="Blue"></label>
                                                        </div>
                                                        <div data-value="Green"
                                                            ...
                                                            <label class="swatchLbl color medium rectangle"
                                                                for="swatch-0-green"
                                                                style="background-image:url({{ asset('frontend/assets/images/product-detail-page/variant1-3.jpg') }});"
                                                                title="Green"></label>
                                                        </div>
                                                        <div data-value="Gray"
                                                            ...
                                                            <label class="swatchLbl color medium rectangle"
                                                                for="swatch-0-gray"
                                                                style="background-image:url({{ asset('frontend/assets/images/product-detail-page/variant1-4.jpg') }});"
                                                                title="Gray"></label>
                                                        </div>
                                                    </div>
                                                </div>
