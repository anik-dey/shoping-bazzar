                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="coupon_value" class="form-control"
                                            placeholder="Coupon Value" value="{{ old('coupon_value') }}" required />
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cart_value" class="form-control"
                                            placeholder="Cart Value" value="{{ old('cart_value') }}" required />
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="expiry_date" id="expiry-date" class="form-control"
                                            placeholder="Expiry-Date" value="{{ old('expire_date') }}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
