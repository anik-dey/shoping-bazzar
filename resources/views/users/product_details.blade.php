            ...
            <div id="MainContent" class="main-content" role="main">
                ...
                <div class="bredcrumbWrap">
                    <div class="container breadcrumbs">
                        <a href="{{ URL::to('/shoping-bazzar/') }}" title="Back to the home page">Home</a><span
                            aria-hidden="true">›</span><span>Product Layout Style</span>
                    </div>
                </div>
                <!--End Breadcrumb-->
                                ...
                                <div class="product-details-img">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="-4"
                                                aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible0.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible0.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big2.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big2.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="-3"
                                                aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big3.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big3.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="-2"
                                                aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible6.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible6.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible7-big.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible7-big.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="-1"
                                                aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible7.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible7.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big4.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big4.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible8.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible8.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big5.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big5.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible9.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible9.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big6.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big6.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible1.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible1.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big7.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big7.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible2.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible2.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big8.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big8.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible3.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible3.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('assets/images/product-detail-page/camelia-reversible-big9.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big9.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible4.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible4.jpg') }}"
                                                    alt="" />
                                            </a>
                                            <a data-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big10.jpg') }}"
                                                data-zoom-image="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big10.jpg') }}"
                                                class="slick-slide slick-cloned" data-slick-index="6" aria-hidden="true"
                                                tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible5.jpg') }}"
                                                    src="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible5.jpg') }}"
                                                    alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="lightboximages">
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big1.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big2.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big3.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible7-big.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big4.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big5.jpg') }}"
                                            data-size="1462x2048"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big6.jpg') }}"
                                            data-size="731x1024"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big7.jpg') }}"
                                            data-size="731x1024"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big8.jpg') }}"
                                            data-size="731x1024"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big9.jpg') }}"
                                            data-size="731x1024"></a>
                                        <a href="{{ asset('frontend/assets/images/product-detail-page/camelia-reversible-big10.jpg') }}"
                                            data-size="731x1024"></a>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="product-single__meta">
                                    ...
                                    <div class="prInfoRow">
                                        ...
                                        <div class="product-sku">Quantity: <span
                                                class="variant-sku">{{ $product->product_quantity }}</span>
                                        </div>
                                ...
                                <div id="quantity_message">Hurry! Only <span class="items">4</span> left in
                                    stock.</div>
                                <form method="post" action="http://annimexweb.com/cart/add"
                                    ...
                                    <p class="infolinks"><a href="#productInquiry" class="emaillink btn"> Ask
                                            About this
                                            Product</a></p>
                                    <!-- Product Action -->
                                ...
                                <p id="freeShipMsg" class="freeShipMsg" data-price="199"><i class="fa fa-truck"
                                        aria-hidden="true"></i> CONGRATULATION <b class="freeShip"><span
                                            class="money" data-currency-usd="$199.00"
                                            data-currency="USD">YOU</span></b> GOT <b>FREE SHIPPING!</b></p>
                    ...
                    <div class="prFeatures">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                                <img src="{{ asset('frontend/assets/images/credit-card.png') }}" alt="Safe Payment"
                                    title="Safe Payment" />
                                <div class="details">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                                <img src="{{ asset('frontend/assets/images/shield.png') }}" alt="Confidence"
                                    title="Confidence" />
                                <div class="details">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                                <img src="{{ asset('frontend/assets/images/worldwide.png') }}"
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-3 feature">
                                <img src="{{ asset('frontend/assets/images/phone-call.png') }}" alt="Hotline"
                                    title="Hotline" />
                                <div class="details">
