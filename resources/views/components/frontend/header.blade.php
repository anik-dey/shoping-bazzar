        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                <div class="text-center">
                    <p class="top-header_middle-text"> Shoping-Bazzar Is All Over The City</p>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
                    ...
                    <ul id="siteNav" class="site-nav medium center hidearrow">
                                        ...
                                        <ul class="grid">
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2"><a href="home13-auto-parts.html"
                                                            class="site-nav lvl-2">Home 13 - Auto Parts</a></li>
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2"><a href="#" class="site-nav lvl-2">2
                                                            New Megamenu style</a>
                                                    </li>
                                                    <li class="lvl-2"><a href="#" class="site-nav lvl-2">Show
                                                            Total Savings <span class="lbl nm_label3">Hot</span></a>
                                                    </li>
                            ...
                            <div class="megamenu style4">
                                <ul class="grid grid--uniform mmWrapper">
                                    ...
                                    <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                        <a href="#"><img src="{{ asset('frontend/assets/images/megamenu-bg1.jpg') }}"
                                                alt="" title="" /></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    ...
                                    <li class="grid__item large-up--one-whole imageCol"><a href="#"><img
                                                src="{{ asset('frontend/assets/images/megamenu-bg2.jpg') }}"
                                                alt=""></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="lvl1 parent dropdown"><a href="#">Blog <i class="anm anm-angle-down-l"></i></a>
                            <ul class="dropdown">
                                ...
                                <li><a href="blog-right-sidebar.html" class="site-nav">Right Sidebar</a>
                                </li>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                <div class="logo">
                    <a href="index.html">
                        <img src="{{ asset('frontend/assets/images/logo.svg') }}"
                        ...
                        <ul class="mini-products-list">
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('frontend/assets/images/product-images/cape-dress-1.jpg') }}"
            ...
            <ul>
                ...
                <li><a href="#" class="site-nav">Home Group 2<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="home13-auto-parts.html" class="site-nav">Home 13 - Auto Parts</a>
                        </li>
                ...
                <li><a href="#" class="site-nav">New Sections<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="home6-modern.html" class="site-nav">Text columns with images</a>
                        </li>
                ...
                <li><a href="#" class="site-nav">New Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="home13-auto-parts.html" class="site-nav">Top Information Bar </a>
                        </li>
            ...
            <ul>
                ...
                <li><a href="#" class="site-nav">Shop Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="shop-right-sidebar.html" class="site-nav">Infinite Scrolling</a>
                        </li>
                        ...
                        <li><a href="product-hover-info.html" class="site-nav">Product Hover Info</a>
                        </li>
        ...
        <li class="lvl1 parent megamenu"><a href="product-layout-1.html">Product <i class="anm anm-plus-l"></i></a>
            <ul>
                ...
                <li><a href="short-description.html" class="site-nav">Product Features<i
                    ...
                    <ul>
                        ...
                        <li><a href="product-quantity-message.html" class="site-nav">Product Quantity
                                Message</a></li>
                        <li><a href="product-visitor-sold-count.html" class="site-nav">Product
                                Visitor/Sold Count </a></li>
                ...
                <li><a href="#" class="site-nav">Product Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        <li><a href="product-with-variant-image.html" class="site-nav">Product with
                                Variant Image</a></li>
                        ...
                        <li><a href="product-with-image-swatch.html" class="site-nav">Product with Image
                                Swatch</a></li>
                        <li><a href="product-with-dropdown.html" class="site-nav">Product with
                                Dropdown</a></li>
                        <li><a href="product-with-rounded-square.html" class="site-nav">Product with
                                Rounded Square</a></li>
                ...
                <li><a href="#" class="site-nav">Product Features<i class="anm anm-plus-l"></i></a>
                    <ul>
                        ...
                        <li><a href="product-pre-orders.html" class="site-nav">Product Pre-orders </a>
                        </li>
                        <li><a href="product-labels-detail.html" class="site-nav">Product Labels</a></li>
                        <li><a href="product-discount.html" class="site-nav">Product Discount In %</a>
                        </li>
